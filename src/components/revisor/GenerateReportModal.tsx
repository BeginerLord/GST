...
export default function GenerateReportModal({
  ...
  const { isGenerating, error, generateNewReport } = useReports()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setLocalError(err.message || "Error al generar el reporte")
    }
  }
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all duration-200 outline-none"
              disabled={isGenerating}
              required
            />
          </div>
