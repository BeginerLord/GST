...
import { useCreateIncidentHook, useGetProcessesForReviewerHook } from "@/hooks/revisor"
...
export default function CreateIncidenceModal({ isOpen, onClose, onSave }: CreateIncidenceModalProps) {
  ...
  const { data: processes, isLoading: loadingProcesses, error: processError } = useGetProcessesForReviewerHook()
  const { createIncidentAsync, isPending: creatingIncident } = useCreateIncidentHook({
    onSuccess: (data) => {
      console.log("Incidencia creada:", data)
      onSave(formData) // Mantener la callback original
      onClose()
      // Reset form
      setFormData({
        processId: "",
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        setFormData((prev) => ({
          ...prev,
          evidence: result, // En una app real, subirías el archivo a un servidor
        }))
      }
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4">
        ...
        <form onSubmit={handleSubmit}>
          <div className="px-6 py-4 max-h-[70vh] overflow-y-auto">
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  <option value="">
                    {loadingProcesses ? "Cargando procesos..." : "Selecciona un proceso"}
                  </option>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Mínimo 10 caracteres. Sé específico sobre el problema encontrado.
                </p>
              </div>
          ...
          <div className="border-t border-gray-200 px-6 py-4 flex justify-end space-x-3">
            ...
            <button
              type="submit"
              disabled={creatingIncident || isSubmitting || !formData.processId || !formData.description.trim() || !selectedFile}
